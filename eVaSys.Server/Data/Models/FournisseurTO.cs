...
{
    /// <summary>
    /// Class for FournisseurTO
    /// </summary>
    public class FournisseurTO : IMarkModification
    {
        #region Constructor
        public FournisseurTO()
        {
        }
        private FournisseurTO(ILazyLoader lazyLoader)
        {
        ...
        {
            string r = "";
            int c = DbContext.FournisseurTOs.Where(q => q.Libelle == Libelle && q.RefFournisseurTO != RefFournisseurTO).Count();
