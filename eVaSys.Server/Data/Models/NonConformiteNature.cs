...
{
    /// <summary>
    /// Class for NonConformiteNature
    /// </summary>
    public class NonConformiteNature : IMarkModification
    {
        #region Constructor
        public NonConformiteNature()
        {
        }
        private NonConformiteNature(ILazyLoader lazyLoader)
        {
        ...
        {
            string r = "";
            int c = DbContext.NonConformiteNatures.Where(q => (q.LibelleFRFR == LibelleFRFR || q.LibelleFRFR == LibelleFRFR) && q.RefNonConformiteNature != RefNonConformiteNature).Count();
