...
{
    /// <summary>
    /// Class for éco-organismes
    /// </summary>
    public class EcoOrganisme : IMarkModification
    {
        #region Constructor
        public EcoOrganisme()
        {
        ...
        {
            string r = "";
            int c = DbContext.EcoOrganismes.Where(q => q.Libelle == Libelle && q.RefEcoOrganisme != RefEcoOrganisme).Count();
