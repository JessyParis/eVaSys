...
{
    /// <summary>
    /// Class for NonConformiteDemandeClientType
    /// </summary>
    public class NonConformiteDemandeClientType : IMarkModification
    {
        #region Constructor
        public NonConformiteDemandeClientType()
        {
        }
        private NonConformiteDemandeClientType(ILazyLoader lazyLoader)
        {
        ...
        {
            string r = "";
            int c = DbContext.NonConformiteDemandeClientTypes.Where(q => (q.LibelleFRFR == LibelleFRFR || q.LibelleFRFR == LibelleFRFR) && q.RefNonConformiteDemandeClientType != RefNonConformiteDemandeClientType).Count();
