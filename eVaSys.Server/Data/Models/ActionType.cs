...
{
    /// <summary>
    /// Class for ActionType
    /// </summary>
    public class ActionType : IMarkModification
    {
        #region Constructor
        public ActionType()
        {
        }
        private ActionType(ILazyLoader lazyLoader)
        {
        ...
        {
            string r = "";
            int c = DbContext.ActionTypes.Where(q => q.Libelle == Libelle && q.RefActionType != RefActionType).Count();
