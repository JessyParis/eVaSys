...
{
    /// <summary>
    /// Class for RegionReporting
    /// </summary>
    public class RegionReporting : IMarkModification
    {
        #region Constructor
        public RegionReporting()
        {
        }
        private RegionReporting(ILazyLoader lazyLoader)
        {
        ...
        {
            string r = "";
            int c = DbContext.RegionReportings.Where(q => q.Libelle == Libelle && q.RefRegionReporting != RefRegionReporting).Count();
