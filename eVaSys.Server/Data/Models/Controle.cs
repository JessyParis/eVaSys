...
namespace eVaSys.Data
{
    ...
    /// Class for Controles
    /// </summary>
    public class Controle : IMarkModification
    {
        #region Constructor
        public Controle()
        {
        }
        private Controle(ILazyLoader lazyLoader)
        {
        ...
        private ControleType _controleType;
        public ControleType ControleType
        {
            get => LazyLoader.Load(this, ref _controleType);
