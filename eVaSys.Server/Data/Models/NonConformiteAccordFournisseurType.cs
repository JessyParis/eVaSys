...
{
    /// <summary>
    /// Class for NonConformiteAccordFournisseurType
    /// </summary>
    public class NonConformiteAccordFournisseurType : IMarkModification
    {
        #region Constructor
        public NonConformiteAccordFournisseurType()
        {
        }
        private NonConformiteAccordFournisseurType(ILazyLoader lazyLoader)
        {
        ...
        {
            string r = "";
            int c = DbContext.NonConformiteAccordFournisseurTypes.Where(q => (q.LibelleFRFR == LibelleFRFR || q.LibelleFRFR == LibelleFRFR) && q.RefNonConformiteAccordFournisseurType != RefNonConformiteAccordFournisseurType).Count();
