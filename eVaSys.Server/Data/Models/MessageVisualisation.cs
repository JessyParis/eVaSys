...
{
    public class MessageVisualisation
    {
        #region Constructor
        public MessageVisualisation()
        {
        }
        private MessageVisualisation(ILazyLoader lazyLoader)
        {
        ...
        {
            string r = "";
            //bool existsInDB = (Utils.Utils.DbScalar("select count(*) from tblMessageVisualisation where RefMessageVisualisation=" + RefMessageVisualisation, DbContext.Database.GetDbConnection()) != "0");
